...
signal period_sig     : std_logic_vector(15 downto 0) := x"30D4";  -- 8 kHz
signal dutyCycle_sig  : std_logic_vector(15 downto 0) := x"186A";  -- 50% DC
...
uut: pwm_module
  port map (
            ...
            i_reset     => reset,
            i_enable    => en_sig,
            i_period    => period_sig(13 downto 0),
            i_dutyCycle => dutyCycle_sig(13 downto 0),
            o_error     => error_sig,
            o_pwm       => pwm_sig
            );
